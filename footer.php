<footer class="site-footer">
    ...
    <div class="search-overlay">
        <div class="search-overlay__top">
            <div class="container">
                <i style="font-size:40px;" class="fa fa-search search-overlay__icon" aria-hidden="true"></i>
                <input type="text" class="search-term" placeholder="What are you looking for?" id="search-term">
                <i style="font-size:30px;" class="fa fa-window-close search-overlay__close" aria-hidden="true"></i>
            </div>
        </div>
        <div class="container">
...
// wp_footer loads our wp function to load JS files, and other cool features
