<?php get_header(); ?>
  ...
  <div class="page-banner__bg-image" style="background-image: url(<?php 
    ...
    // get_theme_file_uri generates the path to the theme folder
  ...
  <div class="full-width-split group">
    ...
    <div class="full-width-split__two">
      <div class="full-width-split__inner">
        ...
        <?php
        // homepagePosts will be our Main OBJECT for the loop
        ...
        <?php } 
        // let's reset the post data so we don't use the custom query anymore
